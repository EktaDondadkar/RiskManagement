...
module.exports = cds.service.impl(async function () {
    ...
    this.after("READ", Risks, (data) => {
        ...
        // Looping through the array of risks to set the virtual field 'criticality' defined in the schema
        risks.forEach((risk) => {
            // Set criticality based on impact value
            ...
            // Set criticality for priority based on prio_code
    ...
    // connect to remote service const
